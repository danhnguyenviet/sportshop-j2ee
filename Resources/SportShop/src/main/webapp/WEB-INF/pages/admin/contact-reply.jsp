	                    ...
	                    <div class="panel panel-default">
	                        ...
	                        <div class="panel-body">
	                            <div class="form-group input-group">
	                                ...
	                                <input type="text" class="form-control" placeholder="Tiêu đề" value="<%= ContactDetail.getTitle() %>" disabled="disabled">
	                            </div>
	                            <div class="form-group input-group">
	                                <span class="input-group-addon">Email người nhận</span>
	                                <input type="text" class="form-control" placeholder="Địa chỉ email người nhận" value="<%= ContactDetail.getEmail() %>" disabled="disabled">
	                            </div>
