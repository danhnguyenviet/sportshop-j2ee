                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <input id="input-username" type="text" class="form-control" name="username" value="<%= User.getUsername() %>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <input id="input-password" type="text" class="form-control" name="password" value="<%= User.getPassword() %>">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <input id="input-fullname" type="text" class="form-control" name="fullname" value="<%= User.getFullname() %>">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-icon right">
                                            <input id="input-email" type="text" class="form-control" name="email" value="<%= User.getEmail() %>">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
...
<!--                                 </div> -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <button type="reset" class="btn btn-default" onclick="resetForm();">XÓA TẤT CẢ</button>
                            <button id="edituser" type="submit" data-id="<%=User.getId() %>" class="btn btn-danger" value="Send" onclick="postRequestToAdmin()" >ĐĂNG DỮ LIỆU</button>
                        </div>
                    </div>
                </div>
            </div>
...
// 			return;
// 		}
		$.post("../admin/saveEditUserRequest", {
					id	:	fid,
					username : fusername,
					password : fpassword,					
					fullname : ffullname,	
				...
				.fail(
						function() {
							alert("Hiện tại quá trình chỉnh sửa tài khoản gặp lỗi. Vui lòng thử lại. Xin cám ơn!");
