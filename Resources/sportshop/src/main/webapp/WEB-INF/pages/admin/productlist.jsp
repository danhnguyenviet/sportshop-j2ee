                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <% for(int i=0; i < newestProductList.size(); i++){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="../admin/editproduct?id=<%=newestProductList.get(i).getId() %>" title="edit"><i class="glyphicon glyphicon-edit"></i></a></td>
<%--                                             <td><a href="../admin/deleteproduct?id=<%=newestProductList.get(i).getId() %>" title="delete"><i class="glyphicon glyphicon-trash"></i></a></td> --%>
											<td><a href="#delete-modal" data-toggle="modal" title="delete" onclick="transformId(<%=newestProductList.get(i).getId() %>)"><i class="glyphicon glyphicon-trash"></i></a></td>
                                        </tr>
                                        <% } else { %>
