			...
			<div class="row">
						...
						<div class="panel-body">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="input-group">
											<span class="input-group-addon">Giá gốc</span> <input id="input-price" name="price" type="text" class="form-control" maxlength="8">
										</div>
									</div>
									<div class="col-md-5">
										<div class="input-group">
											<span class="input-group-addon">Giá giảm</span> <input id="input-pricePromotion" name="pricePromotion" type="text" class="form-control">
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<div class="input-group">
											<span class="input-group-addon">Số lượng hiện có</span> <input id="input-quantity" name="quantity" type="text" class="form-control">
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<div class="getfile"
											...
											<input id="input-images" name="images" type="file" multiple></input>
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
				...
				<div class="col-lg-4">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<button type="submit" class="btn btn-danger form-submit" onclick="sendProductInfo()">Thêm sản phẩm</button>
