                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <ul class="list bullet text-fill">
                                    <li><a href="index.html" data-hover="Trang chủ">Trang chủ</a></li>
                                    <li><a href="about.html" data-hover="Giới thiệu">Giới thiệu</a></li>
                                    <li><a href="category.html" data-hover="Sản phẩm">Sản phẩm</a></li>
                                    <li><a href="blog.html" data-hover="Tin tức">Tin tức</a></li>
                        ...
                        <div class="box customer-service">
                            ...
                            <div class="box-content">
                                <ul class="list bullet text-fill">
                                    ...
                                    <li><a href="category.html">Giày thể thao</a></li>
                                    <li><a href="category.html">Dụng cụ thể thao</a></li>
                                    <li><a href="category.html">Máy tập thể thao</a></li>
                                    <li><a href="category.html">Sản phẩm dinh dưỡng</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
