...
public class BackendController {
    ...
    public ModelAndView homeAdmin(Model model, HttpServletRequest request) {
	...
	public ModelAndView login(@RequestParam(value = "error", required = false) String error,
		...
		if (logout != null) {
			model.addObject("msg", "Bạn vừa đăng xuất thành công!");
		}
	...
	public String saveProductInfo(Model model, HttpServletRequest request,
			...
			@RequestParam(value = "description") String description_c, @RequestParam(value = "price") Double price_c,
	...
	public String updateProductInfo(Model model, HttpServletRequest request,
			@RequestParam(value = "title") String title_c, @RequestParam(value = "id") Integer id_c,
			@RequestParam(value = "dateCreate") String dateCreate_c, @RequestParam(value = "alias") String alias_c,
			@RequestParam(value = "description") String description_c, @RequestParam(value = "price") Double price_c,
			@RequestParam(value = "pricePromotion") Double pricePromotion_c,
	...
	public String doAddNews(Model model, HttpServletRequest request, HttpServletResponse response,
	...
	public String showOrderDetailList(Model model, HttpServletRequest request, @RequestParam(value = "id") int id)
			throws Exception {
	...
	public String confirmOrder(Model model, HttpServletRequest request, @RequestParam(value = "id") int id,
	...
	public String editNews(Model model, @RequestParam(value = "id", defaultValue = "-1") int newsId) throws Exception {
	...
	public String doEditNews(Model model, HttpServletRequest request, HttpServletResponse response,
	...
	public String deleteNews(Model model, HttpServletRequest request, HttpServletResponse response,
	...
	public String adduser(HttpServletRequest request, HttpServletResponse response,
			...
			@RequestParam(value = "isactive") int isactive) throws Exception {
		try {
			User user = new User();
			user.setId(null);
	...
	@RequestMapping(value = { "/admin/saveEditUserRequest" }, method = RequestMethod.POST)
	public String saveEditUser(HttpServletRequest request, HttpServletResponse response,
			@RequestParam(value = "id") int id, @RequestParam(value = "username") String username,
			@RequestParam(value = "password") String password, @RequestParam(value = "fullname") String fullname,
			@RequestParam(value = "email") String email, @RequestParam(value = "isactive") int isactive)
			throws Exception {
		try {
			User user = userDAO.getUserById(id);
			user.setUsername(username);
	...
	@RequestMapping(value = { "/admin/deleteContact" }, method = RequestMethod.POST)
	public String deleteConact(HttpServletRequest request, HttpServletResponse response,
			@RequestParam(value = "id") int id) throws Exception {
		try {
