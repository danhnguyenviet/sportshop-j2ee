                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a data-toggle="modal" href='#addcategory'><i class="fa fa-plus"></i> Thêm loại bài viết</a>
                            <div class="modal fade" id="addcategory">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title">Thêm loại bài viết</h4>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="">Bài viết nổi bật
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="">Bài viết mới
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="">Xem nhiều nhất
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="">Bình luận nhiều
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
