    ...
    <div class="row">
        ...
        <section id="sidebar-main" class="col-md-9">
            <div id="content">
                ...
                <div class="tabs-group box">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-description">
                            <div>
                            <p>Áo thun thể thao đồng phục may đẹp với các kiểu dáng adidas, nike mẫu mới nhất trong năm nay để làm đồng phục có form dành cho nam và nữ Giao hàng tận nơi, bảo hành đổi mới sản phẩm Nhận cung cấp mọi số lượng May theo kiểu áo adidas, kiểu áo thun chơi Gol, kèm theo các loại nón đội, in thêu logo lên nón in áo thun bóng đá</p>
                            <p>Bóng rổ hiện đang là môn học được đưa vào chương trình học của của các trường đại học và phổ thông. Với sự phổ biến này đã có nhiều tài năng trẻ đi lên từ các trường trên cả nước. Không những vậy phong trào thi đấu bóng rổ của các bạn sinh viên cũng khá là nhộn nhịp. Chính vì vậy mà mẫu đồng phục bóng rổ màu vàng pha đỏ đã cho các bạn sự tham khảo trước khi lựa chọn cho đội bóng của mình một mẫu đồng phục thể thao ưng ý.</p>
                            <p>Màu đỏ trên áo bằng công nghệ in chuyển nhiệt trên áo thun đã tạo ra những đường kẻ sọc dưới than áo một cách hài hòa và chỉnh chu. Với mẫu quần lại được chèn thêm một đường vải dọc thân tạo ra điểm nhấn cho mẫu đồng phục bóng rổ thêm nổi bật.</p>
                            </div>
                        </div>
                ...
                <!-- Related Product -->
                <%@ include file= "related-product.jsp" %>
            </div>
        </section>
    </div>
</div>
